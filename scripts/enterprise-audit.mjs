...
const checks = [
  ...
  ['src/engine/input/inputController.ts', ['connectHidDevice', 'applyForceFeedback', 'usagePage']],
  ['src/engine/input/hidProfiles.ts', ['buildForceFeedbackReport', 'resolveHidProfile', 'Logitech-style']],
  ['src/engine/physics/vehicleModel.ts', ['pacejkaMagicFormula', 'CENTER_OF_MASS_HEIGHT_M', 'weatherGripMultiplier', 'PHYSICS_TICK_HZ']],
  ...
  ['src/engine/rendering/webgpuRenderer.ts', ['@group(0) @binding(0)', 'drawPrecipitation', 'generateStreamingRoad', 'writeBuffer']],
