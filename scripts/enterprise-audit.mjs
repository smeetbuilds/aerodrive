...
const checks = [
  ...
  ['src/app/page.tsx', ['data-started', 'data-launch-action', '?launch=1#drive', '#settings', 'consumeUrlAction', 'handleNativeLaunchTap', 'pointerup', 'touchend', 'hasStarted', 'shellHealth', 'orientationBlocked', 'lockLandscape', 'Play Now', 'Ready on Play', 'startup-overlay-portrait', 'Turn your phone sideways to start', 'hasStarted ? (']],
  ['src/app/startup.css', ['z-index: 60', 'z-index: 80', 'startup-overlay', 'orientation-overlay', 'play-button', 'orientation-phone', 'pointer-events: none', 'animated-phone', 'phone-orientation-hint', 'touch-action: manipulation', 'text-decoration: none']],
